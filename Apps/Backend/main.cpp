...
//
//int main() {
//  std::string configPath = "fb_config.json";
//
//    // Чтение токена и URL
//    std::string authToken;
//    // std::string authToken, databaseURL;
//    try {
//        authToken = AuthHandler::getAuthToken(configPath);
//        // databaseURL = AuthHandler::getDatabaseURL(configPath);
...
//   FirebaseHandler firebase("https://your-project-id.firebaseio.com", authToken);
//
//   // Отправка данных
